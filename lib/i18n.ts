...
export const t = {
  ...
  notifications: {
    ...
    emptyBody: 'Aquí verás cada prospecto y candidato nuevo en cuanto entre.',
  ...
  campaigns: {
    ads: {
      ...
      preview: {
        ...
        loading: 'Cargando creativo desde Meta…',
        unavailable: 'Vista previa no disponible',
        mediaUnavailable: 'Meta no permitió recuperar la imagen o el video de este anuncio.',
        videoUnavailable: 'El video no está disponible; se muestra la miniatura.',
        noText: 'Este anuncio no tiene texto disponible.',
        campaign: 'Campaña',
        adSet: 'Conjunto',
        status: 'Estado',
        destination: 'Destino',
        openInMeta: 'Abrir en Meta',
        close: 'Cerrar',
      },
    },
    conversionFunnel: {
  ...
  leads: {
    ...
    detail: {
      ...
      archiveConfirm: (name: string) =>
        `${name} dejará de aparecer en Prospectos, en el embudo y en las métricas. Podrás restaurarlo desde la papelera.`,
      archiveAction: 'Eliminar',
      archivedToast: 'Prospecto enviado a la papelera',
      restoredToast: 'Prospecto restaurado',
      archiveError: 'No se pudo eliminar el prospecto',
      onlyAdminsDelete: 'Solo un Distribuidor o Asistente puede eliminar prospectos.',
  ...
  settings: {
    ...
    profile: {
      ...
      emailNewLeadLabel: 'Recibir correo cuando entre un prospecto nuevo',
      emailNewLeadDescription: 'Solo Distribuidores y Asistentes del workspace reciben este aviso. Puedes desactivarlo cuando quieras.',
